...
test -s "$ROUNDTRIP_TMP/exported/platform/windows/main.cpp"
test -s "$ROUNDTRIP_TMP/exported/platform/windows/platform.cpp"
...
test -s "$ROUNDTRIP_TMP/exported/CMakeLists.txt"
grep -q '^if(WIN32)' "$ROUNDTRIP_TMP/exported/CMakeLists.txt"
grep -q 'platform/windows/main[.]cpp' "$ROUNDTRIP_TMP/exported/CMakeLists.txt"
grep -q 'refract_deploy_runtime' "$ROUNDTRIP_TMP/exported/CMakeLists.txt"
grep -q 'WIN32_EXECUTABLE TRUE' "$ROUNDTRIP_TMP/exported/CMakeLists.txt"
! grep -q 'REFRACT_DESKTOP_DIALOGS OFF' "$ROUNDTRIP_TMP/exported/CMakeLists.txt"
! grep -q 'REFRACT_USE_FFMPEG OFF' "$ROUNDTRIP_TMP/exported/CMakeLists.txt"
